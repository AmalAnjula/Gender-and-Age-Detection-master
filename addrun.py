...
class SlideshowApp(tk.Tk):
    def __init__(self, *args, **kwargs):
        ...
        self.image_paths = self.load_images(r'C:\Users\Amal\Downloads\Gender-and-Age-Detection-master', self.first_character)  # Replace with the actual path to your image folder
